...
from agents.specialist_agent import SalarySpecialistAgent
...
class EnsembleAgent(Agent):
    ...
    def __init__(self, collection):
        ...
        self.specialist = SalarySpecialistAgent()
    ...
    def salary(self, description):
        ...
        specialist = self.specialist.salary(rewrite)
        frontier = self.frontier.salary(rewrite)
        neural_network = self.neural_network.salary(rewrite)
