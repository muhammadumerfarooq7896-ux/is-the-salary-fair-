...
SYSTEM_PROMPT = """Create a concise description of a job posting. Respond only in this format. Do not include application instructions or company boilerplate.
Title: Rewritten short precise job title
Category: eg Software Engineering, Data Science, DevOps
Seniority: eg Junior, Mid, Senior, Staff
Description: 1 sentence on core responsibilities
Requirements: 1 sentence on key required skills/experience"""
